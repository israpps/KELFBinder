...
extern char ConsoleROMVER[17];

/**
 * @brief console model detector, for protokernels, model is detected by reading ROMVER, any newer model will be detected by issuing a S-Command

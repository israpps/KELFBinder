...
--
-- HDD:
HDD_EXTRA_INST_COUNT = 3 -- SIZE OF THE `HDD_EXTRA_INST_SRC` TABLE
HDD_EXTRA_INST_SRC = { -- CONTAINS SOURCE FILES FOR INSTALLATION, __LEAVING THIS TABLE EMPTY WILL MAKE THE PROGRAM CRASH__
  "INSTALL/ASSETS/PS2BBL/CONFIG.INI",
  "INSTALL/ASSETS/BOOT/BOOT.ELF",
  "INSTALL/ASSETS/APPS/OPNPS2LD.ELF"
}

HDD_EXTRA_INST_FOLDE = 1 -- SIZE OF THE `HDD_EXTRA_INST_MKD` TABLE
HDD_EXTRA_INST_MKD = {
  "PS2BBL",
}

HDD_EXTRA_INST_DST = { -- CONTAINS DESTINATION PATHS FOR THE FILES LISTED ON `HDD_EXTRA_INST_SRC` -- __SAME ORDER MUST BE RESPECTED__
  "PS2BBL/CONFIG.INI",
  "BOOT/BOOT.ELF",
  "APPS/OPNPS2LD.ELF"
}
